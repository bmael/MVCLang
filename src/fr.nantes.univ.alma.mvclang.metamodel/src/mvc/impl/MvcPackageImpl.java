...
public class MvcPackageImpl extends EPackageImpl implements MvcPackage {
	 ...
	 * @generated
	 */
	public EReference getModelProperty_Model() {
	...
	public void createPackageContents() {
		...
		createEReference(modelPropertyEClass, MODEL_PROPERTY__MODEL);
	...
	public void initializePackageContents() {
		...
		modelPropertyEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEReference(getView_Model(), this.getModel(), null, "model", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModel_Properties(), this.getModelProperty(), this.getModelProperty_Model(), "properties", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(modelPropertyEClass, ModelProperty.class, "ModelProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModelProperty_Model(), this.getModel(), this.getModel_Properties(), "model", null, 1, 1, ModelProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
