 ...
 * <ul>
 *   <li>{@link mvc.impl.ModelImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link mvc.impl.ModelImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends NamedElementImpl implements Model {
	...
	public EList<Model> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<Model>(Model.class, this, MvcPackage.MODEL__OWNED_ELEMENTS);
		}
	...
	public EList<ModelProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentWithInverseEList<ModelProperty>(ModelProperty.class, this, MvcPackage.MODEL__PROPERTIES, MvcPackage.MODEL_PROPERTY__MODEL);
		}
		return properties;
	}
